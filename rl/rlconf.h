/* rlconf.h -- rl configuration definitions */
...
/* This definition is needed by rl.c, rltty.c, and signals.c. */
/* If on, then rl handles signals in a way that doesn't suck. */
...
/* Define this if you want code that allows rl to be used in an
   X `callback' style. */
