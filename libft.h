...
t_list				*ft_lstmap(t_list *lst, void *(*f)(void *),
							void (*del)(void *));
t_list				*ft_lst_at(t_list *lst, int i);
void				ft_lst_print(t_list *lst);
void				ft_lstadd_back_element(t_list **lst, void *new);
...
int					ft_digit_count(int a);
float				ft_atof(char *str);
void				ft_splitline_free(char **split_line);
int					ft_split_count_elements(char **split_line);
